...
def copy_items(src_table, dest_table):    
...
def copy_table(src_dynamodb, dest_dynamodb, src_table_name, dest_table_name):    
    try:    
        ...
        copy_items(source_table, dest_table)    
...
source_table_name = 'pco-app-content'  
source_region = 'us-east-1'  

destination_profile_name = 'default'  
destination_table_name = 'pco-app-content-PROD'  
...
# Call the function    
copy_table(src_dynamodb, dest_dynamodb, source_table_name, destination_table_name)    
